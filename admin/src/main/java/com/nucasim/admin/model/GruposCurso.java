...
public class GruposCurso implements Serializable{
	...
	private EstadoGrupoCurso estado;
	...
	public GruposCurso(int grupo, String descripcion, Cursos curso, Date fechaInicial, Date fechaFinal, int valorCurso,
			EstadoGrupoCurso estado, byte[] observaciones, Entrenadores entrenador, Date actualizado) {
		super();
		this.grupo = grupo;
	...
	public EstadoGrupoCurso getEstado() {
		return estado;
	}

	public void setEstado(EstadoGrupoCurso estado) {
		this.estado = estado;
	}
